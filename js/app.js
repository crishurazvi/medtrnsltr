...
function showModal(content, size = "") {
  ...
  document.body.insertAdjacentHTML(
    "beforeend",
    `<div id="modal-root" class="modal-backdrop">
...
function renderAuth() {
  ...
  app.innerHTML = `
    <main class="auth-page">
      <section class="auth-visual">
        <div class="brand-mark">M</div>
        <h1>Traducere medicală, fără integrarea unui API AI.</h1>
        <p>PDF-ul este extras local în browser. Copiezi promptul în instrumentul AI ales, lipești traducerea și continui. Proiectul Supabase pe care îl introduci păstrează datele tale.</p>
        <div class="auth-points">
          <span>✓ Nicio cheie DeepSeek, OpenAI sau Claude în aplicație</span>
          <span>✓ URL-ul și cheia Publishable Supabase se introduc la login</span>
          <span>✓ Autosalvare, glosar medical și export PDF</span>
        </div>
      </section>
      <section class="auth-panel">
        <form id="auth-form" class="auth-card auth-card-wide">
          <h2>${isSignup ? "Creează cont" : "Conectare și autentificare"}</h2>
          <p>Conectează aplicația la proiectul tău Supabase, apoi introdu contul de utilizator.</p>
            ...
            <fieldset class="connection-fieldset">
              ...
              <div class="form-row">
                ...
                <div class="secret-input-row">
                  ...
                  <button id="toggle-key" class="btn btn-ghost btn-sm" type="button">Arată</button>
                </div>
              ...
              <label class="checkbox-row">
                ...
                <span>Ține minte URL-ul și cheia Publishable în acest browser.</span>
              </label>
            </fieldset>

            <fieldset class="connection-fieldset">
              <legend>2. Cont utilizator</legend>
              <div class="form-row">
  ...
  document.querySelector("#toggle-key")?.addEventListener("click", () => {
    const input = document.querySelector("#supabase-key");
  ...
  document.querySelector("#auth-form")?.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (!sameConnection(state.connection, nextConnection)) {
...
function renderDashboard() {
  ...
  const projectCards = state.projects.length
    ...
    : `<div class="empty-state" style="grid-column:1/-1">
        ...
        <p>Încarcă primul PDF, extrage textul local și începe traducerea prin copy–paste.</p>
  ...
  app.innerHTML = `
    <div class="app-shell">
      ...
      <main class="container">
        <section class="hero">
          <div class="hero-main">
            <h1>Traduceri medicale organizate, fără integrare AI.</h1>
            <p>PDF-ul este împărțit în segmente, promptul se copiază automat, traducerea se lipește în editor, iar progresul este salvat în Supabase.</p>
    ...
    <form id="create-project-form">
      <div class="modal-body form-grid">
        ...
        <div class="form-row">
          ...
          <span class="help">2.000–3.500 de caractere este o zonă bună pentru copy–paste. Segmentele mai mari reduc repetarea promptului.</span>
        </div>
        <div class="form-row">
          ...
          <div class="editor-main">
            ...
            <div class="translation-panels">
              ...
              <section class="editor-panel">
                ...
                <textarea id="translated-text" class="code-editor" placeholder="Lipește aici traducerea furnizată de ChatGPT, Claude, DeepSeek sau alt instrument…">${escapeHtml(chunk.translated_text || "")}</textarea>
              </section>
            </div>
...
window.addEventListener("beforeunload", () => saveDebounced?.cancel?.());
